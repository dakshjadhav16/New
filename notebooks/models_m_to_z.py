...
try:
    ...
    dataset_path = r'D:\Sem6\EDAI\New\data\lkandmarks_dataset_augmented.csv'
    if os.path.exists(dataset_path):
        ...
        df = pd.read_csv(r'D:\Sem6\EDAI\New\data\lkandmarks_dataset.csv')
...
"""
joblib.dump(rf_model, 'random_forest_model_m_to_z.joblib')
print("Model saved successfully as 'random_forest_model_m_to_z.joblib'")

# Method 2: Save using pickle
with open('random_forest_model_m_to_z.pkl', 'wb') as f:
    pickle.dump(rf_model, f)
print("Model also saved as 'random_forest_model_m_to_z.pkl'")
